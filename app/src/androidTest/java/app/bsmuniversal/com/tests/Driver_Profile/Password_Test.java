 ...
 */
public class Password_Test extends BaseTestClass {
    @Rule
    ...
    public void test_emptyPassword() {
        ...
        Driver_Profile_Page.change_password("","");
        Driver_Profile_Page.click_on_change_password_button();
    }

    @Test
    public void test_inCorrect_CurrentPassword() {
        SelectAssetPage.go_to_home_screen_from_select_asset_screen();
        DrawerPage.open_navigation_drawer();
        assert_navigation_drawer_opened(DrawerLocators.navigation_drawer, true);
        DrawerPage.click_on_navigation_item(DrawerLocators.nav_Driver_profile);
        Driver_Profile_Page.change_password("",Users.getUserOne().getPassword());
        Driver_Profile_Page.click_on_change_password_button();
    }
    ...
    public void test_changePassword() {
        ...
        assert_navigation_drawer_opened(DrawerLocators.navigation_drawer, true);
        DrawerPage.click_on_navigation_item(DrawerLocators.nav_Driver_profile);
        Driver_Profile_Page.change_password(Users.getUserOne().getPassword(),Users.getUserOne().getPassword());
        Driver_Profile_Page.click_on_change_password_button();
    }
