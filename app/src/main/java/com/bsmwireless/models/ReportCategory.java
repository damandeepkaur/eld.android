...
public class ReportCategory implements Parcelable {
    ...
    public final static Parcelable.Creator<ReportCategory> CREATOR = new Creator<ReportCategory>() {

        @SuppressWarnings({
            "unchecked"
        })
        public ReportCategory createFromParcel(Parcel in) {
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("ReportCategory{");
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ReportCategory)) {
            return false;
        }
