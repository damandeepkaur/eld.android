...
public enum DutyType {
    OFF_DUTY(0, R.string.hos_txt_offduty, R.color.offduty_light),
    SLEEPER_BERTH(1, R.string.hos_txt_sleepingberth, R.color.sleepingberth_light),
    DRIVING(2, R.string.hos_txt_driving, R.color.driving_light),
    ON_DUTY(3, R.string.hos_txt_onduty, R.color.onduty_light);
