...
public final class TopSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public boolean onLayoutChild(CoordinatorLayout parent, V child, int layoutDirection) {
        ...
        mMinOffset = Math.max(topPadding-child.getHeight(), topPadding-(child.getHeight() - mPeekHeight));
        mMaxOffset = topPadding;
...
//        mMaxOffset = mParentHeight - peekHeight;
     ...
     * @attr ref android.support.design.R.styleable#TopSheetBehavior_Params_behavior_hideable
     */
